        ...
        .done((data) => {
            ...
            if (data.ok) {
                $.each(data.body, (index, denuncia) => {
                    ...
                    const fechaFormateada = formatFecha(denuncia.fechaRegistro);
                    t.row.add([botonera, denuncia.id, denuncia.titulo, denuncia.descripcion,denuncia.ubicacion,denuncia.estado, denuncia.ciudadano, denuncia.telefonoCiudadano, fechaFormateada]);
                });
                t.draw(false);
            } else {
...
$(document).ready(function () {
    ...
    $(document).on('click', '.eliminar', function () {
        ...
        Swal.fire({
            ...
            text: "¿Está seguro de querer eliminar esta denuncias?",
            icon: 'warning',
